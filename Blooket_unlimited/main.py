...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        ## SET ==> WINDOW TITLE
        self.setWindowTitle('Main Window - Blooket Unlimited')
        UIFunctions.labelTitle(self, 'Main Window - Blooket Unlimited')
        UIFunctions.labelDescription(self, 'Main Menu')
        ## ==> END ##
    ...
    def Button(self):
        ...
        if btnWidget.objectName() == "btn_home":
            ...
            UIFunctions.labelPage(self, "Main Hacks")
